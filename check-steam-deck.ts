 ...
 */
function initializePushover(userKey?: string, apiToken?: string): Push | null {
  if (userKey && apiToken) {
...
async function sendNotification(
  pushover: Push | null,
  message: string,
  title: string = "Steam Deck Restock Alert",
  priority: number = 0,
  ...
  try {
    ...
    await pushoverSend(notificationMessage);
 ...
 */
function checkAllDevicesAvailability(cartButtonTexts: string[]): string[] {
